...
namespace XLua
{
    public partial class DelegateBridge : DelegateBridgeBase
    {
		...
		public InvokeLua.ICalc __Gen_Delegate_Imp0(int mult, string[] args)
		{
		...
		public void __Gen_Delegate_Imp2(bool obj)
		{
#if THREAD_SAFT || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public double __Gen_Delegate_Imp3(double arg1, double arg2)
		{
#if THREAD_SAFT || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp4(string obj)
		{
#if THREAD_SAFT || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public void __Gen_Delegate_Imp5(double obj)
		{
#if THREAD_SAFT || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public System.Collections.IEnumerator __Gen_Delegate_Imp32(object self)
		{
#if THREAD_SAFT || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public int __Gen_Delegate_Imp34(object self)
		{
#if THREAD_SAFT || HOTFIX_ENABLE
            lock (luaEnv.luaEnvLock)
            {
		...
		public override Delegate GetDelegateByType(Type type)
		{
			...
			{
			    return new __Gen_Hotfix_Delegate17(__Gen_Delegate_Imp32);
			}
		
		    if (type == typeof(__Gen_Hotfix_Delegate18))
			{
			    return new __Gen_Hotfix_Delegate18(__Gen_Delegate_Imp33);
			}
		
		    if (type == typeof(__Gen_Hotfix_Delegate19))
			{
			    return new __Gen_Hotfix_Delegate19(__Gen_Delegate_Imp34);
			}
    ...
    [HotfixDelegate]
    public delegate System.Collections.IEnumerator __Gen_Hotfix_Delegate17(object p0);
    
    [HotfixDelegate]
    public delegate RDHorseController __Gen_Hotfix_Delegate18(object p0, UnityEngine.Vector3 p1);
    
    [HotfixDelegate]
    public delegate int __Gen_Hotfix_Delegate19(object p0);
